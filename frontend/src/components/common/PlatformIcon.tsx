...
/**
 * Platform-specific SVG icons rendered as inline elements.
 * Using simple SVG paths instead of external deps to keep bundle tight.
 */
...
export function PlatformIcon({ platform, className, size = 14 }: PlatformIconProps) {
